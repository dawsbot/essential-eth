  ...
  it('should match expected hash - addresses', () => {
    const inputs = [
      ...
      },
      {
        ...
        expected:
          '0x36020dd625e805ec80eb7c7e36e5b69108500af4bb4913245a3d643d33466581',
      },
    ];
  ...
  it('should match expected hash - strings', () => {
    const inputs = [
      ...
      },
      {
        ...
        expected:
          '0xf9b3d91668a0f53719a929eb38ac29b07896b3a33ef806cfbe5033bb5ce1e58b',
      },
      {
        types: ['string', 'string', 'string'],
        values: ['example1', '2934823', 'true'],
        expected:
          '0x731e3313bb527075d72c8a724eea170cdc200edf65c958d3014f666faf9a4d41',
      },
    ];
    testSolidityKeccak256(inputs);
  });
  ...
  it('should match expected hash for bytes (dynamic size) & BytesLike', () => {
    const inputs = [
      ...
      },
      {
        ...
        expected:
          '0x89ddb668afdb92cd9027c2ecf8ef3f36f2a76d07f72db32f17be6ddd5552abfb',
      },
      {
        types: ['bytes', 'bytes'],
        values: [
        ...
        expected:
          '0xb57d179e947e0bfe9813227c428eeea3558dc20e47a9fe64b9d9f29b9b5eeff0',
      },
    ];
    testSolidityKeccak256(inputs);
  });
  it('should match expected hash for bytes (static size)', () => {
    const inputs = [
      ...
      },
      {
        ...
        expected:
          '0xe44f351d6a5adfe8e8917ee07b7269e9fb019a97fba5eeab82899b02e3f15d1f',
      },
    ];
    testSolidityKeccak256(inputs);
  });
  ...
  it('should match expected hash for (signed and unsigned) integers', () => {
    const inputs = [
      ...
      },
      {
        ...
        values: [12],
        expected:
          '0x505be1cd98680abcc2473d7336b83f86f30185d233a18e7dbf9a0add7f7fb583',
      },
      {
        types: ['int16', 'uint48'],
        values: [-1, 12],
    ...
    const inputs = [
      {
        ...
        expected:
          '0xa7bbaa8154fe7d3d9a9d813fa435b386fd75dc57d02b620baafc04074658c454',
      },
      {
        ...
        expected:
          '0x6e4e133a4879decc8bf952c54092cb965ba979f38d5e6fb62d47e6bdd7ea390c',
      },
      {
        ...
        expected:
          '0xb66a5a976e76e7f2d8b2d5baff670f9937c12b6c3484a9479075d9ecfc2700d2',
      },
    ];
    testSolidityKeccak256(inputs);
  });
