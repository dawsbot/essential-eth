...
ethers.js won by being simpler than web3. viem is gaining by being type-safe. essential-eth wins by being _essential_ — everything you need, nothing you don't. 40 kB vs 400 kB isn't a feature. It's a philosophy.

---

## The Moat

essential-eth is **8-12x smaller** than every major Ethereum library. That's not an optimization — it's a structural advantage. The alternatives _cannot_ shed that weight without breaking changes. Every feature they add makes them heavier. Every feature we add keeps us lean. Time is on our side.

### The Landscape (weekly npm downloads)
...
| **web3.js**       |   569,797 |    495.1 kB    | The original. Can't tree-shake. 453 kB for _conversions_.                           |
...
This framing lets people adopt essential-eth _alongside_ their existing stack:
