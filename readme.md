...
| ---------------------------------------- | :------------------: | :-----------: | :---------: | :---------: | :------------: | :-----------------: |
| **Full library**                         |    **49.6 kB** 🏆    |   394.0 kB    |  348.3 kB   |  506.6 kB   |    615.6 kB    |         N/A         |
| **Provider** (getBalance, getBlock, etc) |       35.2 kB        |   260.0 kB    |  269.5 kB   |  465.3 kB   | **10.9 kB** 🏆 |         N/A         |
| **Contract** (read-only calls)           |    **30.1 kB** 🏆    |    86.6 kB    |  179.8 kB   |  276.5 kB   |    49.9 kB     |         N/A         |
| **Conversions** (wei, gwei, ether)       |    **1.2 kB** 🏆     |    10.4 kB    |   2.7 kB    |  465.3 kB   |     3.7 kB     |      113.7 kB       |

essential-eth is **7x smaller** than the nearest competitor for full-library usage.
