...
| ---------------------------------------- | :------------------: | :-----------: | :---------: | :---------: | :------------: |
| **Full library**                         |    **39.9 kB** 🏆    |   394.0 kB    |  348.3 kB   |  495.1 kB   |    615.6 kB    |
| **Provider** (getBalance, getBlock, etc) |       28.9 kB        |   260.0 kB    |  269.5 kB   |  453.8 kB   | **10.9 kB** 🏆 |
| **Contract** (read-only calls)           |    **24.8 kB** 🏆    |    86.6 kB    |  179.8 kB   |  264.9 kB   |    49.9 kB     |
| **Conversions** (wei, gwei, ether)       |    **1.2 kB** 🏆     |    10.4 kB    |   2.7 kB    |  453.8 kB   |     3.7 kB     |
