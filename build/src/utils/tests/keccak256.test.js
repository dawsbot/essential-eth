...
const _toUtf8Bytes = require("../to-utf8-bytes");
/**
 *
 * @param inputs
 */ function testKeccak256(inputs) {
    inputs.forEach((input)=>{
        expect((0, _keccak256.keccak256)(input)).toBe(_ethers.utils.keccak256(input));
    });
}
describe('keccak256', ()=>{
    ...
    it('should match ethers.js numbers', ()=>{
        const inputs = [
            ...
            123346,
            12395712
        ].map((n)=>(0, _toUtf8Bytes.toUtf8Bytes)(n.toString()));
        testKeccak256(inputs);
    });
