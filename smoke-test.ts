...
assert(
  'etherToWei("1")',
  etherToWei('1').toString() === '1000000000000000000',
);
assert(
  'weiToEther("1000000000000000000")',
  weiToEther('1000000000000000000').toString() === '1',
);
assert(
  'etherToGwei("1")',
...
assert(
  ...
  gweiToEther('1000000000').toString() === '1',
);
...
const tb = tinyBig(10);
assert('tinyBig(10).times(3)', tb.times(3).toNumber() === 30);
assert('tinyBig instanceof TinyBig', tb instanceof TinyBig);
assert('toHexString()', tinyBig(255).toHexString() === '0xff');
